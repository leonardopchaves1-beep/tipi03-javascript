...
if (numerico > 8) {
    console.log("O número informado [e maior que 8")
}

const nomealuno = "Juliano";

if (nomealuno === "Juliano") { console.log("Óla Juliano"); }

if (nomealuno === "Maria") {
    console.log("Óla Maria"); //perceba que esse bloco foi ignorado
}
...
switch (opcao) {
    ...
    case "sushi":
        ...
        break;
    case "hamburguer":
        console.log("Habúrguer suculento!");
        break;
    default:
