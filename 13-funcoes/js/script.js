...
funcaoParametro("Teste de Função de parâmetro")
funcaoParametro("Testando novamente")
...
//Funções que retornaram algo (return)
function soma2(m, n){
    return m + n;
}
...
//Funções que não retornaram nada (void)
...
console.log(Math.min(4, 9, 1)); // número maior / minimo
...
const dobrados = lista.map(x => x * 2); //aplica função em cada item    
