...
console.log(nomes[0]);
console.log(nomes[1]);
console.log(nomes[2]); //essa posição não existe (undefined)
...
//Encontrar a primeira ocorrência de elemento especificado
const frutas = ["maça", "banana", "manga", "abacaxi"];

console.log(frutas.indexOf("maça"));
console.log(frutas.indexOf("laranja"));

//Encontrar a última ocorrÊncia de elemento especificado
...
//Veferica se um elemento está presente no array
...
//desestruturar array
const novoArray = ["Nátalia", "Eduarda", "Milena"];
